...
def save_dictionary(dictionary, filename):  # Định nghĩa hàm để lưu từ điển vào tệp
...
def load_dictionary(filename):  # Định nghĩa hàm để nạp từ điển từ tệp
...
def main():  # Định nghĩa hàm main để chạy chương trình
    ...
    dictionary = load_dictionary(filename)  # Nạp từ điển từ tệp
